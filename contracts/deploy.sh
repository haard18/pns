...
# PNS Complete Deployment Script
# This script deploys all contracts, initializes them, and sets up roles
# Usage: ./deploy.sh

set -e

echo "🚀 PNS Deployment Script"
echo "======================="
...
echo "  NFT:           $NFT"
echo ""
echo "Export these for quick reference:"
...
echo "  export USER1=0x3C44CdDdB6a900c2Cf0852ca0cE2380e3360a69a"
echo "  export USER1_KEY=0x5de4111afa1a4b94908f83103db1fb50da4c89699e6dffb97ae4e8e89143a01b"
echo ""
echo "Example: Register a domain"
echo "  cast send \$CONTROLLER 'registerDomain(string,address,uint256)' 'alice' \$USER1 1 \\"
echo "    --rpc-url http://localhost:8545 --private-key \$USER1_KEY --value 50ether"
